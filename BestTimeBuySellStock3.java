...
public class BestTimeBuySellStock3 {
    ...
    static int maxProfit(int[] prices){
        ...
        //return solveRecursion(prices, 0, 0, 2);

        //Using Memoization with T.C=O(n*2*3)(3D array space) & S.C=O(n*2*3)+O(n)(3D array and recursion stack space)
        ...
        //    }
        //}
        //return solveMemoization(prices, 0, 0, dp, 2);

        //Using Tabulation with T.C=O(n*2*3)(for 3 nested loops) & S.C=O(n*2*3)(3D array space)
        //return solveTabulation(prices);

        //Using Space Optimization with T.C=O(n*2*3)(for 3 nested loops) & S.C=O(1)
